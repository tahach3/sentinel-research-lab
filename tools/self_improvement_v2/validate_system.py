...
REQUIRED_FILES = [
    ...
    "docs/SELF_IMPROVEMENT_V2_AGENT_RUNTIME_CONTRACT.md",
    ...
    "specs/self_improvement/v2/agent_runtime_contract.schema.json",
    ...
    "tools/self_improvement_v2/agent_runtime_contract.py",
